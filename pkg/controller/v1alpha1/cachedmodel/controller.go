...
func (c *CachedModelReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	nodeGroupNamespacedName := types.NamespacedName{Name: cachedModel.Spec.NodeGroups[0]}
	...
	cachedModel.Status.ModelCopies = &v1alpha1api.ModelCopies{TotalCopies: totalNodes, SuccessfulCopies: successfulNodes}
